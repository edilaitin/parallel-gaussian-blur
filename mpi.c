...
void perform(int nStart, int nStop, int width, int height, int radius, unsigned char *red, unsigned char *green, unsigned char *blue)
{
...
int main(int argc, char *argv[])
{
    ...
    redBuffer = (unsigned char *)malloc(width * height);
    greenBuffer = (unsigned char *)malloc(width * height);
    blueBuffer = (unsigned char *)malloc(width * height);
    ...
    if (my_PE_num == 0)
    {
        ...
        perform(nStart, nStop, width, height, radius, red, green, blue);
    }
